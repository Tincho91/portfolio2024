  ...
  return (
    <div className='py-20' id="projects">
      <h1 className='heading'>
        ...
        <span className='text-purple'>my proyects</span>
      </h1>
      <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-1 mt-10'>
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <a href={link} target="_blank" key={id} className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
